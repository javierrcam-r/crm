        ...
        <div className="flex items-center justify-between px-3.5 sm:px-5 py-3 sm:py-4 border-b border-gray-200 dark:border-dark-600 bg-gradient-to-r from-violet-500/10 to-indigo-500/10 dark:from-violet-500/5 dark:to-indigo-500/5">
          <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white leading-tight">CalendIA</h2>
              <p className="text-[10px] sm:text-[11px] text-gray-500 dark:text-gray-400 leading-tight truncate">Visitas o actividades con lenguaje natural</p>
            </div>
          </div>
          <button onClick={onClose} className="p-2 -mr-1 rounded-lg hover:bg-gray-200 dark:hover:bg-dark-600 transition-colors flex-shrink-0" aria-label="Cerrar">
          ...
          {step === 'input' && (
            <>
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <p className="text-[10px] sm:text-[11px] text-gray-500 dark:text-gray-400 -mt-0.5 sm:-mt-1 leading-snug">
                ...
                <div className="relative">
                  <textarea
                    ...
                    placeholder="Ej: visita con Ana mañana a las 10, y reunión de equipo a las 3pm..."
                    rows={3}
                    className="w-full rounded-xl border border-gray-200 dark:border-dark-500 bg-gray-50 dark:bg-dark-700 px-3 sm:px-4 py-2.5 sm:py-3 pr-[88px] text-[13px] sm:text-sm text-gray-900 dark:text-white placeholder:text-gray-400 focus:ring-2 focus:ring-violet-500 focus:border-transparent resize-none"
                  />
          ...
          {step === 'preview' && (
            <>
              ...
              <div className="flex gap-2 sm:gap-2.5">
                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Sparkles className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-[13px] sm:text-sm text-gray-700 dark:text-gray-300 leading-snug">{aiMessage}</p>
                  {isAmbiguous && ambiguousMsg && (
                    <div className="mt-2 flex items-start gap-2 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20">
                      <AlertTriangle className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-amber-500 flex-shrink-0 mt-0.5" />
                      <p className="text-[11px] sm:text-xs text-amber-700 dark:text-amber-400 leading-snug">{ambiguousMsg}</p>
                    </div>
                  )}
                  <p className="text-[10px] sm:text-[11px] text-gray-400 dark:text-gray-500 mt-1.5 flex items-center gap-1 leading-snug">
                    <Pencil className="h-3 w-3 flex-shrink-0" />
                    <span>Edita cada campo o da más instrucciones abajo</span>
                  </p>
                </div>
              </div>
              ...
              {/* Refine input */}
              {!allCreated && (
                <div className="pt-2.5 sm:pt-3 mt-1 border-t border-gray-200 dark:border-dark-600 space-y-1.5 sm:space-y-2">
                  <label className="flex items-center gap-1.5 text-[10px] sm:text-[11px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-200 dark:border-dark-500 bg-gray-50 dark:bg-dark-700 pl-3 pr-16 sm:pr-20 py-2 sm:py-2.5 text-[13px] sm:text-sm text-gray-900 dark:text-white placeholder:text-gray-400 focus:ring-2 focus:ring-violet-500 focus:border-transparent"
                    />
          ...
          {step === 'input' ? (
            <>
              ...
              <button
                onClick={handleSubmit}
                disabled={!inputText.trim() || loading}
                className="px-3.5 sm:px-4 py-2 rounded-xl bg-gradient-to-r from-violet-500 to-indigo-600 text-white text-[13px] sm:text-sm font-medium hover:from-violet-600 hover:to-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center gap-1.5 sm:gap-2 shadow-lg shadow-violet-500/20 flex-shrink-0"
              >
            ...
            <>
              <button
                ...
                className="px-2.5 sm:px-3 py-2 rounded-xl text-[13px] sm:text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-dark-600 transition-colors flex-shrink-0"
              >
                Volver
              </button>
              <div className="flex items-center gap-2 min-w-0">
                {allCreated ? (
                  <span className="text-[13px] sm:text-sm text-emerald-600 dark:text-emerald-400 font-medium flex items-center gap-1.5">
                  ...
                  >
                    ...
                    <span className="whitespace-nowrap">Confirmar {validCount > 0 ? `(${validCount})` : ''}</span>
                  </button>
                )}
              </div>
            </>
